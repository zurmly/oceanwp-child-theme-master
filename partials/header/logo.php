...
<div class="loginTop">
	<div class="site-loginTop-inner">
		<div class="login-link">
			<?php if (is_user_logged_in()) { ?>
				<a class="login_button" href="<?php echo wp_logout_url( home_url() ); ?>">Logout</a>
			<?php } else { ?>
				<a class="login_button" id="show_login" href="">כניסת תלמידים</a>
			<?php } ?>
		</div>
		<div class="verticalLine"></div>
		<div class="search-toggle-li"><a href="#" class="site-search-toggle search-dropdown-toggle"><span class="icon-magnifier"></span></a></div>
